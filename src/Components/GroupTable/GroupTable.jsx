        ...
        <div className={classes.container}>
            ...
            <div className={classes.table_body}>
                <div className={classes.table_body_div}>
                    ...
                    <div className={classes.table_body_data_div}>
                        Other <span>₹{props.salary[0]?.total_earnings.toFixed(2)}</span>
                    </div>
                    <div className={classes.table_body_data_div}>
                        Gross Salary <span>₹{props.salary[0]?.net_salary.toFixed(2)}</span>
                    </div>
                    <div className={classes.table_body_data_div}>
                    </div>
                    <div className={classes.table_body_data_div}>
                    ...
                    <div className={classes.table_body_data_div}>
                        Total : <span>₹{props.salary[0]?.net_salary.toFixed(2)}</span>
                    </div>
                </div>
                <div className={classes.table_body_div}>
                    <div className={classes.table_body_data_div}>
            ...
            <div className={classes.table_footer}>
                <div className={classes.table_footer_data}>
                    Net Salary <span>₹{props.salary[0]?.net_payable_salary.toFixed(2)}</span>
                </div>
                <div className={classes.table_footer_data}>
                    Paid Incentive <span>₹{props.salary[0]?.cash_incentive.toFixed(2)}</span>
                </div>
                {/* <div className={classes.table_footer_data}>
