  ...
  return (
    <div className={classes.sidebar}>
      ...
      <ul className={classes.sidebar_ul}>
        ...
        <li>
          <NavLink onClick={() => { props.onSideberBtn() }} to={'/attendence_corrections'} className={`${classes.sidebar_a} ${location.pathname.includes('attendance_corrections') ? 'active' : ''}`}><img src={Report} alt="" />Attendance Correction</NavLink>
        </li>
        <li>
        ...
        {/* {permissions.includes('Salary') && <li>
          <NavLink onClick={() => { props.onSideberBtn() }} to={'/salary_details'} className={`${classes.sidebar_a} ${location.pathname.includes('salary_detail') ? 'active' : ''}`}><img src={Wallet} alt="" />Salary Details</NavLink>
        </li>}
        {permissions.includes('Salary') && <li>
